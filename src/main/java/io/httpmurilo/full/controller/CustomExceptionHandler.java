...
import io.httpmurilo.full.exception.StandardError;
...
public class CustomExceptionHandler {
    ...
    public ResponseEntity<StandardError> notFound(CustomNotFoundException exception, ServletRequest request) {
